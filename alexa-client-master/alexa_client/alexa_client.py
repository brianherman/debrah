...
class AlexaClient(object):
    ...
    def process_alexa_response(self, res, save_to=None):
        ...
        if res.status_code == requests.codes.ok:
            ...
            # Strip these from the mp3 length = 606
            # --b4b48aeb-e7cd-460b-bb7b-5fefee175955\r\nContent-Type: applicat
            # ion/json\r\n\r\n{"messageHeader":{},"messageBody":{"directives":[{"
            # namespace":"Speaker","name":"SetMute","payload":{"mute":false}},{"n
            # amespace":"SpeechSynthesizer","name":"speak","payload":{"contentIde
            # ntifier":"amzn1.as-ct.v1.Domain:Application:Knowledge#ACRI#Knowledg
            # ePrompt.1c17be09-dd8c-4585-8439-93ea13ed1c93","audioContent":"cid:K
            # nowledgePrompt.1c17be09-dd8c-4585-8439-93ea13ed1c93_25960828"}}]}}\r
            # \n--b4b48aeb-e7cd-460b-bb7b-5fefee175955\r\nContent-ID: <KnowledgePr
            # ompt.1c17be09-dd8c-4585-8439-93ea13ed1c93_25960828>\r\nContent-Type:
            #  audio/mpeg\r\n\r\n
            # Strip this from the end of the file length=45
            # "\r\n--b4b48aeb-e7cd-460b-bb7b-5fefee175955--\r\n'"
            if len(response_data) < 606:
                return None

            audio = response_data[606:len(response_data)-45]
            if audio:
                if save_to:
    ...
    def ask(self, audio_file, save_to=None):
        ...
        with open(audio_file, 'rb') as in_f:
            ...
            if res.status_code == 403:
                ...
                url, headers, request_data = self.get_request_params()
                # Resend request
                res = requests.post(url, headers=headers, files=open(audio_file,'rb'))
